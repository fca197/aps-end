...
(
    ...
    bom_cost_price decimal
(
    15,
    6
) null comment '成本价',
    bom_cost_price_unit varchar
(
    255
) null comment '单位',
    bom_inventory decimal
(
    15,
    6
) null comment '库存',
...
(
    1
) default 0 null comment '是否删除 0 否,1 是',
...
(
    15,
    6
) default 0.000000 null comment '库存',
    is_follow tinyint
(
    1
) default 0 null comment '是否关注',
    factory_id bigint null comment '工厂ID',
    tenant_id bigint null comment '租户ID',
    is_delete tinyint
(
...
create index idx_g_id
    on aps_goods_bom (group_id) comment '组Id ';
...
(
    ...
    forecast_begin_date varchar
(
    255
) null comment '开始时间',
    forecast_end_date varchar
(
    255
) null comment '结束时间',
    tenant_id bigint null comment '租户ID',
...
(
    ...
    comment
    '商品ID',
    forecast_make_main_no
    varchar
(
    255
) null comment '编码',
    forecast_make_main_name varchar
(
    255
) null comment '名称',
    forecast_make_main_begin_date varchar
(
    255
) null comment '开始时间',
    forecast_make_main_end_date varchar
(
    255
) null comment '结束时间',
    factory_id bigint null comment '工厂ID',
...
(
    ...
    comment
    '商品ID',
    forecast_make_month_no
    varchar
(
    255
) null,
    forecast_make_month_name varchar
(
    255
) null,
    forecast_make_month_begin_date varchar
(
    255
) null,
    forecast_make_month_end_date varchar
(
    255
) null,
    factory_id varchar
...
(
    ...
    weeks text null,
    forecast_main_id varchar
(
    255
) null,
    is_deploy tinyint null,
    bom_use_begin_date varchar
(
    255
) null,
    bom_use_end_date varchar
(
    255
) null
    )
...
(
    ...
    logistics_path_name varchar
(
    255
) null comment '物流路径名称',
    logistics_path_remark varchar
(
    255
) null comment '备注',
...
(
    ...
    reserve_datetime varchar
(
    255
) null,
    finish_payed_amount decimal
(
    15,
    6
) null comment '总价',
    finish_payed_datetime varchar
(
    255
) null,
    make_finish_date varchar
(
    255
) null,
...
(
    ...
    goods_unit_price decimal
(
    15,
    6
) null comment '成本价',
    goods_unit_total_price decimal
(
    15,
    6
) null comment '成本价',
...
(
    ...
    process_path_name varchar
(
    255
) null,
    process_path_remark varchar
(
    255
) null,
...
(
    ...
    constraints_name varchar
(
    255
) null,
    constraints_context text null,
    constraints_remark varchar
(
    255
) null,
    tenant_id bigint null comment '租户ID',
...
(
    1
) default 0 null comment '是否默认 0 否,1 是',
    tenant_id bigint null comment '租户ID',
    is_delete tinyint
(
    1
...
(
    255
) null comment '配置类型 sale,part,bom ,sleep',
    config_biz_id bigint null comment '配置业务ID',
    config_biz_name varchar
(
    255
) null comment '配置业务名称',
...
(
    ...
    comment
    '工厂ID',
    scheduling_day_version_no
    varchar
(
    255
) null comment '排程版本号',
    scheduling_day date null comment '排程日期',
    is_issued_third tinyint
(
    1
) default 0 null comment '是否下发 0 否,1 是',
    tenant_id bigint null comment '租户ID',
    is_delete tinyint
(
    1
...
(
    255
) null comment '配置类型 sale,part,bom',
    config_biz_id bigint null comment '配置业务ID',
    config_biz_name varchar
(
    255
...
(
    1
) default 0 null comment '是否匹配 0 否,1 是',
    loop_index int null comment '循环次数',
    loop_enough tinyint
(
    1
) default 0 null comment '是否满足 0 否,1 是',
    tenant_id bigint null comment '租户ID',
    is_delete tinyint
(
    1
...
(
    ...
    version_num int default 0 null comment '版本号',
    scheduling_version_name varchar
(
    255
) null,
    scheduling_constraints_id varchar
(
    255
) null,
    header_list text null,
    capacity_header_list text null,
    capacity_date_list varchar
(
    1024
) null,
    scheduling_day_count bigint null,
    version_step smallint null,
    version_step_error varchar
(
    255
) null,
...
(
    1
) default 0 null comment '是否按钮 0 否,1 是',
...
(
    ...
    supplier_addr varchar
(
    255
) null,
    supplier_remark varchar
(
    255
) null,
    is_delete tinyint
...
(
    ...
    form_item_default_value varchar
(
    512
) null comment '表单项默认值',
    form_item_value_type varchar
(
    64
) null comment '表单值类型  text , date , dateTime ,array',
    is_add_flow_value tinyint
(
    1
) default 0 null comment '是否添加流程变量 0 否,1 是',
    is_required tinyint
(
    1
) default 0 null comment '是否必填 0 否,1 是',
    sort_index int default 0 null comment '排序',
    lose_focus_event varchar
(
    512
) null comment '失去焦点事件',
    tenant_id bigint null comment '租户ID',
...
(
    1
) default 0 null comment '是否添加流程表单值 0 否,1 是',
    is_required tinyint
(
    1
) default 0 null comment '是否必填 0 否,1 是',
...
(
    ...
    goods_cost_price_total decimal
(
    15,
    6
) null comment '成本总价'
...
(
    ...
    version_num int default 0 null comment '版本号',
    tenant_id bigint null comment '租户ID',
    cost_price_total decimal
(
    15,
    6
) null comment '成本总价',
    sales_price_total decimal
(
    15,
    6
) null comment '销售总额',
    goods_gross_profit_total decimal
(
    15,
    6
) null comment '毛利总额',
    goods_net_profit_total decimal
(
    15,
    6
) null comment '净利总额',
...
(
    ...
    goods_gross_profit decimal
(
    15,
    6
) null comment '毛利',
    goods_net_profit decimal
(
    15,
    6
) null comment '净利',
    goods_inventory_count varchar
(
    255
) null,
    is_delete tinyint
...
(
    ...
    version_num int default 0 null comment '版本号',
    order_total_sale_price decimal
(
    15,
    6
) null comment '成本价'
...
(
    ...
    goods_sale_price decimal
(
    15,
    6
) null comment '成本价',
    goods_gross_profit varchar
(
    255
) null,
    goods_net_profit varchar
(
    255
) null,
    is_delete tinyint
...
(
    ...
    version_num int default 0 null comment '版本号',
    goods_total_sale_price decimal
(
    15,
    6
) null comment '成本价'
...
(
    ...
    dictionary_sort varchar
(
    255
) null,
    dictionary_ext varchar
(
    255
) null,
    tenant_id bigint null comment '租户ID',
