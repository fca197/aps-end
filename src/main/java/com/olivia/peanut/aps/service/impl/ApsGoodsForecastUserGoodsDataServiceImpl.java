...
@Transactional
public class ApsGoodsForecastUserGoodsDataServiceImpl extends MPJBaseServiceImpl<ApsGoodsForecastUserGoodsDataMapper, ApsGoodsForecastUserGoodsData> implements
  ...
  public @Override ApsGoodsForecastUserGoodsDataQueryListRes queryList(ApsGoodsForecastUserGoodsDataQueryListReq req) {
    ...
    List<ApsGoodsForecastUserGoodsDataDto> dataList = list.stream().map(t -> $.copy(t, ApsGoodsForecastUserGoodsDataDto.class)).collect(Collectors.toList());
  ...
  public @Override DynamicsPage<ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes> queryPageList(ApsGoodsForecastUserGoodsDataExportQueryPageListReq req) {
    ...
    if (Boolean.TRUE.equals(req.getQueryPage())) {
      ...
      IPage<ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes> dataList = list.convert(t -> $.copy(t, ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes.class));
      records = dataList.getRecords();
    } else {
      records = $.copyList(this.list(q), ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes.class);
    }

    // 类型转换，  更换枚举 等操作

    List<ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes> listInfoRes = $.copyList(records, ApsGoodsForecastUserGoodsDataExportQueryPageListInfoRes.class);

    return DynamicsPage.init(page, listInfoRes);
  }


  public @Override void setName(List<? extends ApsGoodsForecastUserGoodsDataDto> apsGoodsForecastUserGoodsDataDtoList) {
  ...
  private MPJLambdaWrapper<ApsGoodsForecastUserGoodsData> getWrapper(ApsGoodsForecastUserGoodsDataDto obj) {
    MPJLambdaWrapper<ApsGoodsForecastUserGoodsData> q = new MPJLambdaWrapper<>();

    if (Objects.nonNull(obj)) {
      q
          .eq(Objects.nonNull(obj.getForecastId()), ApsGoodsForecastUserGoodsData::getForecastId, obj.getForecastId())
  ...
  private void setQueryListHeader(DynamicsPage<ApsGoodsForecastUserGoodsData> page) {
    ...
    tableHeaderService.listByBizKey(page, "ApsGoodsForecastUserGoodsDataService#queryPageList");
