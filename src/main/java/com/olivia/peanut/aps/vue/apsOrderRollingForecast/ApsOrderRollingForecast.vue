<template>
  <div class="app-container">
    <el-form v-show="showSearch" ref="queryForm" :inline="true" :model="queryParams" label-width="88px" size="small">
      ...
      <el-form-item label="开始时间" prop="beginningTime">
        <el-input v-model="queryParams.data.beginningTime" clearable placeholder="请输入开始时间" @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="唯一编码" prop="rollCode">
          <el-input v-model="form.rollCode" clearable placeholder="请输入唯一编码" @keyup.enter.native="handleQuery"/>
        </el-form-item>
        <el-form-item label="名称" prop="rollName">
          <el-input v-model="form.rollName" clearable placeholder="请输入名称" @keyup.enter.native="handleQuery"/>
        </el-form-item>
        <el-form-item label="开始时间" prop="beginningTime">
          <el-input v-model="form.beginningTime" clearable placeholder="请输入开始时间" @keyup.enter.native="handleQuery"/>
        </el-form-item>
        <el-form-item label="结束时间" prop="endTime">
          <el-input v-model="form.endTime" clearable placeholder="请输入结束时间" @keyup.enter.native="handleQuery"/>
        </el-form-item>
...
export default {
  ...
  created() {
    document['pagePath'] = '/apsOrderRollingForecast'
    this.getList()
  },
  methods: {
    /** 查询公告列表 */
