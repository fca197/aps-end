<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="apsRollingForecastOrderList" @selection-change="handleSelectionChange">
    ...
    <el-dialog :title="title" :visible.sync="open" append-to-body width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="结束时间" prop="endTime">
          <el-input v-model="form.endTime" clearable placeholder="请输入结束时间"/>
        </el-form-item>
  ...
  methods: {
    ...
    getList() {
      ...
      queryPageList(this.queryParams).then(response => {
        ...
        this.apsRollingForecastOrderList = response.dataList
