...
/**
 * (ApsGoodsForecastUserSaleData)文件导入监听
 *
 * @author peanut
 * @since 2024-03-30 18:29:07
 */
public class ApsGoodsForecastUserSaleDataImportListener extends AnalysisEventListener<ApsGoodsForecastUserSaleDataImportReq> {
