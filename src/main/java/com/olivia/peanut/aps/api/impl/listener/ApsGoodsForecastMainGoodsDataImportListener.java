...
/**
 * (ApsGoodsForecastMainGoodsData)文件导入监听
 *
 * @author peanut
 * @since 2024-04-02 13:44:29
 */
public class ApsGoodsForecastMainGoodsDataImportListener extends AnalysisEventListener<ApsGoodsForecastMainGoodsDataImportReq> {
