...
/**
 * (ApsOrderGoodsProjectConfig)文件导入监听
 *
 * @author peanut
 * @since 2024-04-09 13:19:37
 */
public class ApsOrderGoodsProjectConfigImportListener extends AnalysisEventListener<ApsOrderGoodsProjectConfigImportReq> {
