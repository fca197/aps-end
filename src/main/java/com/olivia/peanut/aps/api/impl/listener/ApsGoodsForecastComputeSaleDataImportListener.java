...
/**
 * (ApsGoodsForecastComputeSaleData)文件导入监听
 *
 * @author peanut
 * @since 2024-03-31 20:58:35
 */
public class ApsGoodsForecastComputeSaleDataImportListener extends AnalysisEventListener<ApsGoodsForecastComputeSaleDataImportReq> {
