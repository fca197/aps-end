package com.olivia.test.forcecast.ortools.constraintsolver.samples;
  ...
  static void printSolution(
    ...
    for (int i = 0; i < data.vehicleNumber; ++i) {
      ...
      while (!routing.isEnd(index)) {
        ...
        route.append(manager.indexToNode(index)).append(" Time(").append(solution.min(timeVar)).append(",").append(solution.max(timeVar)).append(") -> ");
